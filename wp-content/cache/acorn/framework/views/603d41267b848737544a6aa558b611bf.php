<footer class="footer bg-blue-100 bg-halftone text-white">
				...
				<div class="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4 mb-6 lg:mb-0 font-medium">
					...
					<div>
						...
						<ul class="list-none mt-2 space-y-2 text-sm">
							...
							<li>
							<a href="<?php echo site_url('/testimonial/'); ?>" class="text-white transition-colors duration-200 hover:text-blue-300 border-b border-transparent hover:border-blue-300">Testimonials</a>
							</li>
						</ul>
					</div>
					<div>
		...
		<div class="border-t border-white border-opacity-25">
			...
			<div class="flex items-center justify-center sm:justify-end">
					...
					<a href="#" target="_blank"><img src="http://localhost/sagotest/wp-content/themes/wootech/resources/assets/images/logo_hellenic-technologies.svg" width="114" height="53" alt="Hellenic Technologies"></a>
				</div>
			</div>
		</div>
	</footer><!--/.footer -->
	...
	<script src="http://localhost/sagotest/wp-content/themes/wootech/resources/assets/js/jquery-3.6.0.min.js"></script>
	<script src="http://localhost/sagotest/wp-content/themes/wootech/resources/assets/js/alpine.min.js"></script>
	<script src="http://localhost/sagotest/wp-content/themes/wootech/resources/assets/js/jquery.validate.min.js"></script>
	<script src="http://localhost/sagotest/wp-content/themes/wootech/resources/assets/js/slick.min.js"></script>
	<script src="http://localhost/sagotest/wp-content/themes/wootech/resources/assets/js/aos.js"></script>
	<script src="http://localhost/sagotest/wp-content/themes/wootech/resources/assets/js/script.js"></script>
</body>
</html><?php /**PATH G:\wamp64\www\ht-assessment\wp-content\themes\wootech\resources\views/sections/footer.blade.php ENDPATH**/ ?>