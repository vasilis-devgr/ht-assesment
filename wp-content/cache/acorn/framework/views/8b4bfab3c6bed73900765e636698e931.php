                    ...
                    <div class="flex space-x-4 justify-end">
                        @foreach(get_field('social_links', 'option') as $social)
                            <a href="{{ $social['url'] }}" target="_blank">
                                <img src="{{ $social['icon']['url'] }}" alt="{{ $social['title'] }}" class="w-6 h-6">
                            </a>
                        @endforeach
                    </div>
                @endif
...
*/?><?php /**PATH G:\wamp64\www\ht-assessment\wp-content\themes\wootech\resources\views/partials/footer.blade.php ENDPATH**/ ?>