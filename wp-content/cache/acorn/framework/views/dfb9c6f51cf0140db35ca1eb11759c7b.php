...
<head>
    ...
    <link rel="icon" type="image/svg+xml" sizes="16x16" href="<?php echo get_template_directory_uri(); ?>/resources/assets/images/favicon.ico">
...
<body>
	<header x-data="{ isOpen: false }" class="bg-white border-b-4 border-gradient relative">
		...
		<a href="<?php echo site_url('/front-page/'); ?>" class="flex">
				<img src="<?php echo get_template_directory_uri(); ?>/resources/assets/images/logo.svg" width="140" height="73" alt="Medical">
			</a>
			...
			<nav x-bind:class="! isOpen ? 'hidden' : ''" class="nav fixed md:static left-0 bg-slate-50 z-10 overflow-y-auto md:overflow-y-visible md:bg-transparent justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu">
				<ul class="flex flex-col mt-6 pb-6 md:pb-0 md:flex-row md:space-x-4 lg:space-x-14 md:mt-0 text-base md:text-[15px] font-bold">
					<li class="dropdown">
						<a href="<?php echo site_url('/shop-page/'); ?>"
						...
						<div
							...
							<div class="md:container md:px-4 px-0">
								<ul
									...
									<li>
										<a href="#" class="block py-2 px-4 md:p-0 hover:bg-gray-400 md:hover:bg-transparent text-blue-100 md:text-white transition-colors duration-200 transform md:border-b-2 md:border-transparent md:hover:border-white md:uppercase">eyeView</a>
									</li>
									<li>
										<a  href="#" class="block py-2 px-4 md:p-0 hover:bg-gray-400 md:hover:bg-transparent text-blue-100 md:text-white transition-colors duration-200 transform md:border-b-2 md:border-transparent md:hover:border-white md:uppercase">eyeCare</a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div
							...
							<div class="md:container md:px-4 px-0">
								<ul
									...
									<li>
										<a href="<?php echo site_url('/testimonial/'); ?>" class="block py-2 px-4 md:p-0 hover:bg-gray-400 md:hover:bg-transparent text-blue-100 md:text-white transition-colors duration-200 transform md:border-b-2 md:border-transparent md:hover:border-white md:uppercase">Testimonials</a>
									</li>
								</ul>
							</div>
						</div>
	...
	</header><!-- /.header --><?php /**PATH G:\wamp64\www\ht-assessment\wp-content\themes\wootech\resources\views/partials/header.blade.php ENDPATH**/ ?>